...
class GladeGlGlade
  ...
  def on_play_button_clicked (widget)
    ...
    pause_button = @glade.get_widget("pause_button")
    pause_button.sensitive = true
    @gl_area.app.resume_game()
  end

  def on_pause_button_clicked (widget)
    p "pause clicked"
    widget.sensitive = false
    play_button = @glade.get_widget("play_button")
    play_button.sensitive = true
    @gl_area.app.pause_game()
  end
